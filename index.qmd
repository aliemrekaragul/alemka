...
about:
  ...
  links:
    ...
    - icon: mail
      text: E-mail
      href: mailto:me@emrekaragul.com
filters:
  - social-share
share:
  permalink: "https://emrekaragul.com/"
...
::: grid
::: {.g-col-12 .g-col-md-6 style="background-color: rgb(252, 239, 180);  border-bottom-left-radius: 25px; border-top-right-radius: 25px;"}
### GREETINGS!
...
::: {.g-col-12 .g-col-md-6 style="background-color: rgb(202, 233, 255); border-top-left-radius: 25px; border-bottom-right-radius: 25px;"}
### EDUCATION
